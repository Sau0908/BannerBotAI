...
const Body = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className="flex-1 mt-64 overflow-hidden sm:mt-0 p-5">
        <h1 className="text-3xl font-bold text-white">
          Welcome to the Ad Banner Generator
        </h1>

        {bannerData.isLoadedWithData && (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 p-6 gap-2 overflow-hidden">
            {[0, 1, 2, 3, 4].map((index) => (
